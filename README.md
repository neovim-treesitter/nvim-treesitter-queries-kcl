# nvim-treesitter-queries-kcl

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-kcl/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-kcl/actions/workflows/validate.yml)

Neovim tree-sitter queries for **kcl**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-kcl",
...
- [ ] Changes are scoped to `kcl` — do not include files for other languages
